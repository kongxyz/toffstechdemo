<form id="signupForm" method="POST" action="php_scripts/mail.php">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select class="form-control" id="plan" name="plan">
          <option value="1">Multi-CDN Enterprise</option>
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label for="origin">Origin /IP to be Protected</label>
        <input type="text" class="form-control" id="origin" name="origin" placeholder="111.11.111.1" required />
      </div>
    </div>
    <div class="col-md-6">
  ...
  <p>By clicking submit, I hereby acknowledge and accept the Privacy Policy and Terms of Use of this website.</p>
